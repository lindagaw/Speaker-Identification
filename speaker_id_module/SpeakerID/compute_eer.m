function [eer, value1, value2, dcf10] = compute_eer(scores, labels, showfig)
...
value1 = scores_sorted(idx1);
value2 = scores_sorted(idx2);
...
if showfig
    ...
    plot_det(FPR, FNR);
    figure;
    plot(scores_sorted, FNR, scores_sorted, FPR);
end
