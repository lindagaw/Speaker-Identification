...
save(strcat(rootDirName,'/models_ubm_manully_pca_selected', num2str(nMixtures),'.mat'), 'ubm');
...
save(strcat(rootDirName,'/models_manully_pca_selected', num2str(nMixtures),'.mat'), 'models');
