...
ubmfiles = dir(strcat(rootDirName, '\ubm-feature-func'));
speakerfiles = dir(strcat(rootDirName,'\feature-func-1'));
...
parfor i = 1 : times
    file = strcat(rootDirName,'\ubm-feature-func\',ubmfiles(i+2).name);
...
save(strcat(rootDirName,'/models_ubm_func', num2str(nMixtures),'.mat'), 'ubm');
...
parfor i = 1 : times
    file = strcat(rootDirName,'\feature-func-1\',speakerfiles(i+2).name);
...
save(strcat(rootDirName,'/models_func_', num2str(nMixtures),'.mat'), 'models');
