...
parfor i = 1 : times
    ...
    numbers = numbers';
    trainUBMData{i} = numbers([1:12 37:48 73:84] ,:);
end
...
save(strcat(rootDirName,'/models_ubm_mfcc', num2str(nMixtures),'.mat'), 'ubm');
...
parfor i = 1 : times
    ...
    numbers = numbers';
    currSpeakerData{1} = numbers([1:12 37:48 73:84] ,:);
...
save(strcat(rootDirName,'/models_mfcc', num2str(nMixtures),'.mat'), 'models');
