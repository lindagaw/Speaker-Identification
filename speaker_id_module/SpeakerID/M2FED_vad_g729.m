function voicing = M2FED_vad_g729( speech, fs, step)

% vadInitCstParams has been modified to use 44100HZ
VAD_cst_param = M2FED_vadInitCstParams;
...
for i = 1 : num_frames
    ...
    voicing(i) = M2FED_vadG729_mex(current_speech, VAD_cst_param);
end
