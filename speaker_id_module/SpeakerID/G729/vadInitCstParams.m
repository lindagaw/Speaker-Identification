...
VAD_cst_param.Fs = single(16000);  % Sampling Frequency
...
VAD_cst_param.L_WINDOW = single(480);  % Window size in LP analysis
VAD_cst_param.L_NEXT   = single(40);   % Lookahead in LP analysis
VAD_cst_param.L_FRAME  = single(160);   % Frame size
