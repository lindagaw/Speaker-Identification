function [ correct_by_file, total_by_file, cannotdecide_by_file, correct_by_speaker, total_by_speaker, cannotdecide_by_speaker ] ...
    = evaluation_USC( trainingDirName, detectionDirName, nMixtures, wavmicros )
sessionSize = 5000;
...
save(strcat(detectionDirName,'/correct_by_file_', num2str(nMixtures),'_',num2str(sessionSize),'.txt'), 'correct_by_file', '-ascii');
save(strcat(detectionDirName,'/total_by_file_', num2str(nMixtures),'_',num2str(sessionSize),'.txt'), 'total_by_file', '-ascii');
save(strcat(detectionDirName,'/canotdecide_by_file_', num2str(nMixtures),'_',num2str(sessionSize),'.txt'), 'cannotdecide_by_file', '-ascii');
save(strcat(detectionDirName,'/correct_by_speaker_', num2str(nMixtures),'_',num2str(sessionSize),'.txt'), 'correct_by_speaker', '-ascii');
save(strcat(detectionDirName,'/total_by_speaker_', num2str(nMixtures),'_',num2str(sessionSize),'.txt'), 'total_by_speaker', '-ascii');
save(strcat(detectionDirName,'/canotdecide_by_speaker_', num2str(nMixtures),'_',num2str(sessionSize),'.txt'), 'cannotdecide_by_speaker', '-ascii');
